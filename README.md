...
National scenario data used in the analysis is available at https://zenodo.org/records/21662719. After obtaining the scenario data, name the IAMC format data file as scen_data.csv and please place it inside `data/scen_data/` folder without changing the file name.
